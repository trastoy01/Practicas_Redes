...
def servidor():
    ...
    try:
        ...
        s.bind(("", args.port))  # Se enlaza a todas las interfaces (dirección IP vacía: incluye localhost)
        ...
        while True:
            try:
                ...
                saludo = "¡Bienvenido al servidor TCP! Soy un servidor de prueba."
                send_with_size(conn, saludo)
